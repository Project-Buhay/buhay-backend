...
def test_directions():
    ...
    response = requests.post(
        url,
        json={
            "start": "121.0696387148319,14.656701242049467",
            "end": "121.0691793275992,14.652877187193631",
        },
    )

    assert response.status_code == 200
    assert response.json() == {
        "route": {"duration": 9.622966646123746, "distanceKm": 0.8019138871769789},
        "geojson": {
            ...
            "features": [
                {
                    ...
                    "geometry": {
                        ...
                        "coordinates": [
                            ...
                            [121.0686241, 14.6535152],
                            [121.0686303, 14.6532023],
                            [121.068631, 14.6531651],
                            [121.0686443, 14.652492],
                            [121.0690834, 14.6524994],
                        ],
                    },
                    "properties": {},
                }
